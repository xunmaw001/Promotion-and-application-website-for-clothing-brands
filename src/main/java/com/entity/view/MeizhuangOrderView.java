...
public class MeizhuangOrderView extends MeizhuangOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String meizhuangOrderValue;
		/**
		* 支付类型的值
		*/
		private String meizhuangOrderPaymentValue;
	...
	public MeizhuangOrderView() {

	}

	public MeizhuangOrderView(MeizhuangOrderEntity meizhuangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, meizhuangOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getMeizhuangOrderValue() {
				return meizhuangOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setMeizhuangOrderValue(String meizhuangOrderValue) {
				this.meizhuangOrderValue = meizhuangOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getMeizhuangOrderPaymentValue() {
				return meizhuangOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setMeizhuangOrderPaymentValue(String meizhuangOrderPaymentValue) {
				this.meizhuangOrderPaymentValue = meizhuangOrderPaymentValue;
			}
