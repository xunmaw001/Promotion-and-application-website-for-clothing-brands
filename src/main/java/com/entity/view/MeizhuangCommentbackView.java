...
public class MeizhuangCommentbackView extends MeizhuangCommentbackEntity implements Serializable {
	...
	public MeizhuangCommentbackView() {

	}

	public MeizhuangCommentbackView(MeizhuangCommentbackEntity meizhuangCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, meizhuangCommentbackEntity);
