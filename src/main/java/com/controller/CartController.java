    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                MeizhuangEntity meizhuang = meizhuangService.selectById(cart.getMeizhuangId());
                if(meizhuang != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("meizhuang_id", cart.getMeizhuangId())
...
//                            cartEntity.setMeizhuangId(Integer.valueOf(data.get(0)));   //商品 要改的
