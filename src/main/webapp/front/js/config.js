...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../meizhuangCollection/list.html'
    }
    ,{
        name: '商品订单',
        url: '../meizhuangOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/fuzhuangpinpaituiguangjiyingyong/admin/dist/index.html#/login";
